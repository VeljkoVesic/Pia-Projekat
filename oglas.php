...
<div id="header">
	...
	<div id="contents">
		...
		<div class="clearfix">
			<div class="main">
				<h1>Okači oglas</h1>
				<p>Dobrodošao na stranicu za postavljanje oglasa! Odaberi parametre koji ti odgovaraju i sačekaj da stignu prijave!</p>
				<form id="forma" action="<?php $_SERVER["PHP_SELF"] ?>" method="get">
				<label>Naziv oglasa:</label> <input id="naslov" name="naslov" type="text"size="20" ><br />
				Lokacija: <input id="lokacija" name="lokacija" type="text" size="20" ><br />
				Stručna sprema: <input id="sprema" name="sprema" type="text" size="10" ><br />
				Opis oglasa: <input id="opis" name="opis" type="textarea" size="10" ><br />
				Rok za prijavu: <input id="rok" name="rok" type="text" size="10" ><br />
				...
				if ($reglog->dodajoglas($naslov, $lokacija,$sprema,$opis, $rok,$id))
				echo "<p><strong>Oglas uspesno dodat</strong></p>";
				else
				echo "<p><strong>Oglas nije uspesno dodat</strong></p>";
}
?>
